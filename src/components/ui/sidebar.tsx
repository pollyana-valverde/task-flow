    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-white outline outline-lime-950/10 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeftIcon className=" text-lime-950/70 group-hover:text-lime-950" />
