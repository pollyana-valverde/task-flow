        ...
        {ACCOUNT_HEADER_LINKS.map((link) => (
          <Link
            ...
            className={cn(
              ...
              pathname === link.path &&
                "shadow-[1.5px_1.5px_0] shadow-lime-950 text-foreground bg-primary border-2 border-foreground dark:border-lime-700 dark:text-primary-foreground"
            )}
            href={link.path}
          >
            {link.label}
